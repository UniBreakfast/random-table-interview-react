...
### Технические условия
Использовать react + redux (я не использовал редакс)
...
Значение места пересечения — объект с уникальным идентификатором ID и количеством Amount: int (3-х значный рандом)
